...
int main(void)
{
    ...
    Vector<double> dr0(3,0.0), dv0(3,0.0);
    try
    {
        ...
        dr0(0) = confData.getValueAsDouble("DRX0", "DEFAULT");
        dr0(1) = confData.getValueAsDouble("DRY0", "DEFAULT");
        dr0(2) = confData.getValueAsDouble("DRZ0", "DEFAULT");
        dv0(0) = confData.getValueAsDouble("DVX0", "DEFAULT");
        dv0(1) = confData.getValueAsDouble("DVY0", "DEFAULT");
        dv0(2) = confData.getValueAsDouble("DVZ0", "DEFAULT");
    ...
    int point( int(length*3600/interval) );
