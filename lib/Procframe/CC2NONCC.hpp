   ...
   class CC2NONCC : public ProcessingClass
   {
      public :
         ...
         virtual gnssDataMap& Process(gnssDataMap& gData)
           ...
           /** Set map of receiver type.
            *
            * @param  rectypeMap    Map of receiver tpye
            */
         virtual CC2NONCC& setRecTypeMap(
                             const std::map<SourceID,std::string>& rectypeMap)
         { sourceRecTypeMap = rectypeMap; return (*this); };
      ...
      private:
         ...
         std::map<SourceID,std::string> sourceRecTypeMap;
