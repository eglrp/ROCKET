...
#ifndef GPSTK_BASICMODEL1_HPP
#define GPSTK_BASICMODEL1_HPP
...
namespace gpstk
{
       ...
       *   BasicModel1 model( nominalPos, sp3Eph );
       *
       *   while(rin >> gRin)
       *   {
       *
       ...
       * @endcode
       *
       * The "BasicModel1" object will visit every satellite in
       ...
       *
       */
   class BasicModel1 : public ProcessingClass
   {
   public:
      ...
      BasicModel1(const Position& staCoordinates);
      ...
      { return minElev; };
         ...
         /// is set to 10 degrees.
      virtual BasicModel1& setMinElev(double newElevation)
                                                    ...
                                                    = SatID::systemGPS ) const
      {
          ...
          */
      virtual BasicModel1& setDefaultObs( const SatID::SatelliteSystem& sys
                                                    = SatID::systemGPS,
      ...
      virtual BasicModel1& setUseTGD(bool tgd,
      ...
      { return nominalPos; };
          ...
          */
      virtual BasicModel1& setNominalPosition(const Position& pos)
      ...
      { return pSP3Store; };
          ...
          */
      virtual BasicModel1& setSP3Store(XvtStore<SatID>& ephStore)
      ...
      { return pBCEStore; };
          ...
          * @param ephStore     XvtStore<SatID> object to be used by default
          */
      virtual BasicModel1& setBCEStore(XvtStore<SatID>& ephStore)
      ...
      { return pMSCStore; };
          ...
          */
      virtual BasicModel1& setMSCStore(MSCStore& msc)
   ...
   }; // End of class 'BasicModel1'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_BASICMODEL1_HPP
