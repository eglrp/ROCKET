...
namespace gpstk
{
                                               ...
                                               const TypeID& type )
    {
             ...
             ++varIter1 )
        {
                 ...
                 ++varIter2 )
            {
                ...
                if( -1 == preIndex1 || -1 == preIndex2 || csflags >= 1.0 )
                {
                    subCovarMatrix( nowIndex1, nowIndex2 ) =
                        subCovarMatrix( nowIndex2, nowIndex1 ) = 0.0;
     ...
     */
    void StateStore::getSourceIDSet(SourceIDSet& sourceSet)
    {
        for( VariableSet::const_iterator varIter = m_VariableSet.begin();
             varIter != m_VariableSet.end();
             ++varIter )
    ...
    StateStore& StateStore::updateNominalPos( gnssDataMap& gData )
    {
             ...
             ++gdsIter )
        {
                 ...
                 ++sdmIter )
            {
                ...
                {
                    cerr << "The station " << sdmIter->first.sourceName
