...
namespace gpstk
{
   ...
   void testSave()
   {
      ...
      for(int i=0;i<1;i++)
      {
         ...
         gRin.body[SatID(1,SatID::systemGPS)][TypeID::C1] = 100.0;
         gRin.body[SatID(2,SatID::systemGPS)][TypeID::C1] = 200.0;

         gRin.body[SatID(1,SatID::systemGPS)][TypeID::C2] = 200.0;
         gRin.body[SatID(2,SatID::systemGPS)][TypeID::C2] = 400.0;
