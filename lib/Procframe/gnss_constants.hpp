...
namespace gpstk
{
   ...
   const long MAX_PRN_GPS    = 32;
      ...
      /** The maximum number of active satellites in the Galileo
       * constellation. */
   const long MAX_PRN_GAL    = 30;

      /** The maximum number of active satellites in the GLONASS
       * constellation. */
   const long MAX_PRN_GLO    = 32;

      /** The maximum number of active satellites in the BeiDou
       * constellation. */
   const long MAX_PRN_BDS    = 35;
