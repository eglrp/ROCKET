...
namespace gpstk
{
    ...
    std::string TimeUpdateCorr::getClassName() const
                 ...
                 ++iter )
            {
                     ...
                     ++vcmIter )
                {
                    ...
                    try
                    {
                        ...
                        {
                            val = m_pStateStore->getSolution( var.getType(),
                                                              m_targetSource,
                                                              (*stvm).first );
                ...
                std::cout << "source: " << m_targetSource
                          << ", sat: " << (*stvm).first
                          << " " << indValue
                          << " " << corr
                          << " " << indValue-corr << std::endl;
            }
        }

        return gData;

    } // End of method 'TimeUpdateCorr::Process()'
