#pragma ident "$Id: CheckCodeData.cpp $"

/**
 * @file CheckCodeData.cpp
...
namespace gpstk
{
   ...
   std::string CheckCodeData::getClassName() const
   { return "CheckCodeData"; }
       ...
       */
   gnssSatTypeValue& CheckCodeData::Process(gnssSatTypeValue& gData)
      throw(ProcessingException)
   {
       ...
       * @param gData      Data object holding the data.
       */
   gnssRinex& CheckCodeData::Process(gnssRinex& gData)
      throw(ProcessingException)
   {
      ...
      * @param gData    Data object holding the data.
      */
    gnssDataMap& CheckCodeData::Process(gnssDataMap& gData)
        throw(ProcessingException)
    {
    ...
    }  // End of method 'CheckCodeData::Process()'
       ...
       * @param gData      Data object holding the data.
       */
    satTypeValueMap& CheckCodeData::Process(satTypeValueMap& gData)
        throw(ProcessingException)
    {
        ...
        try
        {
            ...
            if(sourceRejected) return gData;

            numSat = gData.numSats();

            Vector<double> staClks(numSat,solution);
