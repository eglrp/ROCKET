...
namespace gpstk
{
   ...
   const double LC_WAVELENGTH_GPS = 0.1069533781421467;

      /// GPS WL (L1+L2) carrier wavelength in meters
   const double WL_WAVELENGTH_GPS = 0.8619184003220056;
   ...
   const double LC_WAVELENGTH_GAL = 0.108941359148506;

      /// GAL WL (L1+L5) carrier wavelength in meters
   const double WL_WAVELENGTH_GAL = 0.751416041306364;

      /// Galileo Gamma constant, E1 and E5a
   const double GAMMA_GAL = 1.793270321;
   ...
   const double LC_WAVELENGTH_BDS = 0.108297212161671;

   const double WL_WAVELENGTH_BDS = 0.846971838466711;

      /// BDS Gamma constant, B1 and B2
   const double GAMMA_BDS = 1.672418845;
