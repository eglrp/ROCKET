...
namespace gpstk
{
    ...
    public:
        ...
        /** Add a new equation to related SourceID.
         *
         * @param equation  the Equation object to be added.
         * @param source    the related SourceID.
         */
        ...
        virtual EquationList getCurrentEquationsList() const
    ...
    private:
        ...
        /// Whether or not this EquationSystemEx is ready
        bool m_IsPrepared;

        /// Current list of equations
        EquationList m_CurrentEquationsList;

        /// Current set of unknowns
        VariableSet m_CurrentUnknowns;

        /// Store the equations related to SourceID.
        SourceEquationMap m_SourceEquationMap;

        /// Set containing sources being currently processed
        SourceIDSet m_CurrentSourceSet;

        /// Set containing satellites being currently processed
        SatIDSet m_CurrentSatSet;

        /// Pointer to object of StateStore
        StateStore* m_pStateStore;

        /// General white noise stochastic model
        static WhiteNoiseModel2 whiteNoiseModel;
        ...
        void prepareUnknownsAndEquations( gnssDataMap& gdsMap );
