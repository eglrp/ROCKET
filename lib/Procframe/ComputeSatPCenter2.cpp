...
namespace gpstk
{
    ...
    std::string ComputeSatPCenter2::getClassName() const
    { return "ComputeSatPCenter2"; }
       ...
       */
    satTypeValueMap& ComputeSatPCenter2::Process( const CommonTime& time,
        ...
        throw(ProcessingException)
    {
        ...
        try
        {
                ...
                ++it)
            {
                ...
                Vector<double> satPCenter = getSatPCenter(sat,time,satPos,sunPos);

//                cout << sat;
//                cout << setprecision(3)
//                     << setw(15) << satPCenter[3]
//                     << endl;
    ...
    }  // End of method 'ComputeSatPCenter2::Process()'
      ...
      * @param gData    Data object holding the data.
      */
    gnssDataMap& ComputeSatPCenter2::Process(gnssDataMap& gData)
        throw(ProcessingException)
    {
       ...
       */
    Vector<double> ComputeSatPCenter2::getSatPCenter( const SatID& satid,
...
//                    cout << satid << setw(10) << satPCcorr[3] << endl;
    ...
    }  // End of method 'ComputeSatPCenter2::getSatPCenter()'
