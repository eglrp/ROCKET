...
/**
 * @file AmbiguityDatum.hpp
 * Class to generate independent ambiguity map given 'gData'
 */

#ifndef GPSTK_AMBIGUITYDATUM_HPP
#define GPSTK_AMBIGUITYDATUM_HPP
...
namespace gpstk
{
      ...
      /// Thrown when attempting to use an invalid AmbiguityDatum
      /// @ingroup exceptiongroup
   NEW_EXCEPTION_CLASS(InvalidAmbiguityDatum, gpstk::Exception);
       ...
       * processed.
       *
       * In order to achieve this, the 'AmbiguityDatum' class will start from a
       ...
       *
       *      // Create 'AmbiguityDatum' object
       *   AmbiguityDatum eqSystem;
       *
   ...
   public:
      ...
      {};
          ...
          */
      virtual AmbiguityDatum& setAmbType( const Variable& type);
          ...
          *
          */
      virtual AmbiguityDatum& Prepare( gnssSatTypeValue& gData )
      { gnssRinex gds(gData); return ( Prepare(gds) ); };
          ...
          *
          */
      virtual AmbiguityDatum& Prepare( gnssRinex& gData );
          ...
          *
          */
      virtual AmbiguityDatum& Prepare( gnssDataMap& gdsMap );
   ...
   private:
      ...
      EdgeSet currentEdges;
         ...
         /// Whether or not this AmbiguityDatumNet is ready to be used
      bool isPrepared;
   ...
   }; // End of class 'AmbiguityDatum'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_AMBIGUITYDATUM_HPP
