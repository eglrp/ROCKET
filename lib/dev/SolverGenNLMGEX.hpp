#pragma ident "$Id: SolverGenNLMGEX.hpp 2648 2011-06-09 08:01:41Z shjzhang $"

/**
 * @file SolverGenNLMGEX.hpp
 * General Solver with ambiguity fixing.
 */

#ifndef GPSTK_SOLVERGENNLMGEX_HPP
#define GPSTK_SOLVERGENNLMGEX_HPP
...
namespace gpstk
{
       ...
       *
       * SolverGenNLMGEX is a program that inherited from the solverGeneral class,
       ...
       * @endcode
       *
       * \warning "SolverGenNLMGEX" is based on an Extended Kalman filter, and
       ...
       *
       * @sa SolverGenNLMGEX.hpp.
       *
       */
   class SolverGenNLMGEX : public SolverBase, public ProcessingClass
   {
   public:
			 ...
			 * 
			 */
		SolverGenNLMGEX() :firstTime(true), fixAndHold(false)
		{};
          ...
          *
          */
      SolverGenNLMGEX(const Equation& equation)
      ...
      { equSystem.addEquation(equation); };
          ...
          *                            be solved.
          **/
      SolverGenNLMGEX( const std::list<Equation>& equationList )
          : firstTime(true), fixAndHold(false)
      {
          ...
          *                            be solved.
          **/
      SolverGenNLMGEX( const EquationSystem2& equationSys )
         :firstTime(true), fixAndHold(false)
      {
      ...
      virtual void AmbiguityUpdate( Vector<double>& state,
          ...
          */
      virtual SolverGenNLMGEX& setIndepAmbiguityDatum( 
      ...
      { indepAmbDatum = ambDatum; return (*this); };
			 ...
			 */
		virtual SolverGenNLMGEX& setEquationSystem( EquationSystem2& equSys )
		{ equSystem = equSys; return (*this); };
          ...
          * @param constrSystem  Object holding the constraint system
          */
      virtual SolverGenNLMGEX& setAmbType( const Variable& var)
      { ambType = var; return (*this); };

      virtual SolverGenNLMGEX& setFixAndHold( const bool& hold)
