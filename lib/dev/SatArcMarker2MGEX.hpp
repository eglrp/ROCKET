#pragma ident "$Id: SatArcMarker2MGEX.hpp 2513 2013-05-30 09:29:32Z shjzhang $"

/**
 * @file SatArcMarker2MGEX.hpp
 * This class keeps track of satellite arcs caused by cycle slips.
 */

#ifndef GPSTK_SATARCMARKER2MGEX_HPP
#define GPSTK_SATARCMARKER2MGEX_HPP
...
namespace gpstk
{
       ...
       * @endcode
       *
       * The "SatArcMarker2MGEX" object will visit every satellite in the GNSS
       ...
       *
       * By default, the "SatArcMarker2MGEX" objects will only watch the
       ...
       * slip happens.
       *
       * An important feature of "SatArcMarker2MGEX" objects is that you can
       ...
       *
       * Likewise, SatArcMarker2MGEX" objects are also able to delete unstable
       ...
       *
       */
   class SatArcMarker2MGEX : public ProcessingClass
   {
      public:
      ...
      { setIndex(); };
          ...
          *                         unstable.
          */
      SatArcMarker2MGEX( const TypeID& watchFlag,
      ...
      { return watchCSFlag; };
          ...
          * @param watchFlag     Cycle slip flag to be watched.
          */
      virtual SatArcMarker2MGEX& setCSFlag(const TypeID& watchFlag)
      ...
      { return deleteUnstableSats; };
          ...
          * @param delUnstableSats  Whether unstable satellites will be deleted.
          */
      virtual SatArcMarker2MGEX& setDeleteUnstableSats(const bool delUnstableSats)
      ...
      { return unstablePeriod; };
          ...
          *                         unstable.
          */
      virtual SatArcMarker2MGEX& setUnstablePeriod(const double unstableTime);
   ...
   }; // End of class 'SatArcMarker2MGEX'
