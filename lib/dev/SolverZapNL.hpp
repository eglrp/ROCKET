#pragma ident "$Id: SolverZapNL.hpp 2648 2011-06-09 08:01:41Z shjzhang $"

/**
 * @file SolverZapNL.hpp
 * General Solver with ambiguity fixing.
 */

#ifndef GPSTK_SOLVERZAPNL_HPP
#define GPSTK_SOLVERZAPNL_HPP
...
namespace gpstk
{
       ...
       *
       * SolverZapNL is a program that inherited from the solverGeneral class,
       ...
       * @endcode
       *
       * \warning "SolverZapNL" is based on an Extended Kalman filter, and
       ...
       *
       */
   class SolverZapNL : public SolverBase, public ProcessingClass
   {
   public:
          ...
          *
          */
      SolverZapNL(const Equation& equation)
          : firstTime(true)
      { equSystem.addEquation(equation); };
          ...
          *                            be solved.
          **/
      SolverZapNL( const std::list<Equation>& equationList )
          : firstTime(true)
      {
          ...
          *                            be solved.
          **/
      SolverZapNL( const EquationSystem2& equationSys )
         :firstTime(true)
      {
      ...
      virtual SolverZapNL& setIndepAmbiguityDatum( 
      ...
      { indepAmbDatum = ambDatum; return (*this); };
          ...
          * @param constrSystem  Object holding the constraint system
          */
      virtual SolverZapNL& setAmbType( const Variable& var)
   ...
   }; // End of class 'SolverZapNL'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERZAPNL_HPP
