#pragma ident "$Id: SolverGenWLMGEX.hpp 2648 2017-02-22 10:43:41Z shjzhang $"

/**
 * @file SolverGenWLMGEX.hpp
 * General Solver with ambiguity fixing.
 */

#ifndef GPSTK_SOLVERGENWLMGEX_HPP
#define GPSTK_SOLVERGENWLMGEX_HPP
...
namespace gpstk
{
       ...
       *
       * SolverGenWLMGEX is a program that inherited from the solverGeneral class,
       ...
       * @endcode
       *
       * \warning "SolverGenWLMGEX" is based on an Extended Kalman filter, and
       ...
       *
       * @sa SolverGenWLMGEX.hpp.
       *
       */
   class SolverGenWLMGEX : public SolverBase, public ProcessingClass
   {
   public:
			 ...
			 * 
			 */
		SolverGenWLMGEX() :firstTime(true), fixAndHold(false)
		{};
          ...
          *
          */
      SolverGenWLMGEX(const Equation& equation)
      ...
      { equSystem.addEquation(equation); };
          ...
          *                            be solved.
          **/
      SolverGenWLMGEX( const std::list<Equation>& equationList )
          : firstTime(true), fixAndHold(false)
      {
          ...
          *                            be solved.
          **/
      SolverGenWLMGEX( const EquationSystem2& equationSys )
         :firstTime(true), fixAndHold(false)
      {
      ...
      virtual void AmbiguityUpdate( Vector<double>& state,
          ...
          */
      virtual SolverGenWLMGEX& setIndepAmbiguityDatum( 
                                    const IndepAmbiguityDatum& ambDatum)
      { indepAmbDatum = ambDatum; return (*this); };

			/** Set equation system
			 *
			 * @param equSys	Object holding the equation systems
			 */
		virtual SolverGenWLMGEX& setEquationSystem( EquationSystem2& equSys )
		{ equSystem = equSys; return (*this); };
          ...
          * @param constrSystem  Object holding the constraint system
          */
      virtual SolverGenWLMGEX& setAmbType( const Variable& var)
      { ambType = var; return (*this); };


 
      virtual SolverGenWLMGEX& setFixAndHold( const bool& hold)
   ...
   }; // End of class 'SolverGenWLMGEX'

      //@}

}  // End of namespace gpstk
#endif   // GPSTK_SOLVERGENWL2_HPP
