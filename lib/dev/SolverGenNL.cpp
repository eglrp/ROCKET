#pragma ident "$Id: SolverGenNL.cpp 2346 2012-05-23 15:55:58Z shjzhang $"

/**
 * @file SolverGenNL.cpp
...
//              will be biased.
//              Thus, in the 'SolverGenNL' class, only the independent 
...
namespace gpstk
{
   ...
   int SolverGenNL::classIndex = 9510000;


      // Returns an index identifying this object.
   int SolverGenNL::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverGenNL::getClassName() const
   { return "SolverGenNL"; }
       ...
       */
   gnssSatTypeValue& SolverGenNL::Process(gnssSatTypeValue& gData)
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverGenNL::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverGenNL::Process(gnssRinex& gData)
      throw(ProcessingException)
   {
       ...
       */
   gnssDataMap& SolverGenNL::Process(gnssDataMap& gdsMap)
      throw(ProcessingException)
   {
       ...
       * @param gData    Data object holding the data.
       */
   gnssDataMap& SolverGenNL::Predict( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
...
//
   ...
   }  // End of method 'SolverGenNL::preCompute()'
      ...
      //
   gnssDataMap& SolverGenNL::Correct( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverGenNL::Compute()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssDataMap& SolverGenNL::MeasUpdate( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
      try
      {
   ...
   gnssDataMap& SolverGenNL::AmbiguityFixing( gnssDataMap& gData )
      throw(ProcessingException)
   {
...
//
   ...
   }  // End of method 'SolverGenNL::AmbiguityFixing()'
       ...
       */
   void SolverGenNL::AmbiguityUpdate( Vector<double>& state,
      ...
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverGenNL::AmbiguityUpdate()'
      ...
      // @param gData    Data object holding the data.
      //
   gnssDataMap& SolverGenNL::postCompute( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
...
//         }  // End of for( VariableSet::const_iterator itVar1 = currentUnknowns...'
   ...
   }  // End of method 'SolverGenNL::postMeasUpdate()'
       ...
       */
   double SolverGenNL::getSolution( const TypeID& type,
   ...
   }  // End of method 'SolverGenNL::getSolution()'
      ...
      throw(InvalidRequest)
   {
       ...
       * of this type, only the first one will be returned.
       */
   double SolverGenNL::getFixedSolution( const TypeID& type,
                                         const SourceID& source ) const
      throw(InvalidRequest)
   {
