...
#ifndef GPSTK_BASICMODELMGEX_HPP
#define GPSTK_BASICMODELMGEX_HPP
...
namespace gpstk
{
       ...
       *   BasicModelMGEX model( nominalPos, sp3Eph );
       *
       *   while(rin >> gRin)
       *   {
       *
       ...
       * @endcode
       *
       * The "BasicModelMGEX" object will visit every satellite in
       ...
       *
       */
   class BasicModelMGEX : public ProcessingClass
   {
   public:
      ...
      { setInitialRxPosition(); };
          ...
          */
      BasicModelMGEX( const double& aRx,
                  const double& bRx,
                  const double& cRx,
      ...
      BasicModelMGEX(const Position& RxCoordinates);
      ...
      { return minElev; };
         ...
         /// is set to 10 degrees.
      virtual BasicModelMGEX& setMinElev(double newElevation)
      ...
      { return defaultObservable; };
          ...
          */
      virtual BasicModelMGEX& setDefaultObservable(const TypeID& type)
      { defaultObservable = type; return (*this); };
          ...
          * @param type      TypeID object to be used by default
          */
      virtual BasicModelMGEX& setDefaultObservable( SatID::SatelliteSystem sys,
																const TypeID& type )
      {
			sysDefaultObservable[ sys ] = type;
      ...
      { return pDefaultEphemeris; };
          ...
          */
      virtual BasicModelMGEX& setDefaultEphemeris(XvtStore<SatID>& ephem)
   ...
   protected:
      ...
      TypeID defaultObservable;
			...
			/// System <---> defaultObservable
		std::map< SatID::SatelliteSystem, TypeID > sysDefaultObservable;
