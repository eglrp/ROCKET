...
/**
 * @file NetworkAmbiDatum.hpp
 * Class to generate independent ambiguity map given 'gData'
 */

#ifndef GPSTK_NETWORKAMBIDATUM_HPP
#define GPSTK_NETWORKAMBIDATUM_HPP
...
namespace gpstk
{
      ...
      /// Thrown when attempting to use an invalid NetworkAmbiDatum
      /// @ingroup exceptiongroup
   NEW_EXCEPTION_CLASS(InvalidNetworkAmbiDatum, gpstk::Exception);
       ...
       * processed.
       *
       * In order to achieve this, the 'NetworkAmbiDatum' class will start from a
       ...
       *
       *      // Create 'NetworkAmbiDatum' object
       *   NetworkAmbiDatum eqSystem;
       *
   ...
   public:
      ...
      {};
          ...
          */
      virtual NetworkAmbiDatum& setAmbType( const Variable& type);
          ...
          *
          */
      virtual NetworkAmbiDatum& Prepare( gnssSatTypeValue& gData )
      { gnssRinex gds(gData); return ( Prepare(gds) ); };
          ...
          *
          */
      virtual NetworkAmbiDatum& Prepare( gnssRinex& gData );
          ...
          *
          */
      virtual NetworkAmbiDatum& Prepare( gnssDataMap& gdsMap );
   ...
   private:
      ...
      EdgeSet currentEdges;
         ...
         /// Whether or not this NetworkAmbiDatumNet is ready to be used
      bool isPrepared;
   ...
   }; // End of class 'NetworkAmbiDatum'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_NETWORKAMBIDATUM_HPP
