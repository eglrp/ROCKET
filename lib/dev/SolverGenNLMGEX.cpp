#pragma ident "$Id: SolverGenNLMGEX.cpp 2346 2012-05-23 15:55:58Z shjzhang $"

/**
 * @file SolverGenNLMGEX.cpp
...
//              will be biased.
//              Thus, in the 'SolverGenNLMGEX' class, only the independent 
...
namespace gpstk
{
   ...
   int SolverGenNLMGEX::classIndex = 9510000;


      // Returns an index identifying this object.
   int SolverGenNLMGEX::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverGenNLMGEX::getClassName() const
   { return "SolverGenNLMGEX"; }
       ...
       */
   gnssSatTypeValue& SolverGenNLMGEX::Process(gnssSatTypeValue& gData)
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverGenNLMGEX::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverGenNLMGEX::Process(gnssRinex& gData)
      throw(ProcessingException)
   {
       ...
       */
   gnssDataMap& SolverGenNLMGEX::Process(gnssDataMap& gdsMap)
      throw(ProcessingException)
   {
       ...
       * @param gData    Data object holding the data.
       */
   gnssDataMap& SolverGenNLMGEX::Predict( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
...
//
   ...
   }  // End of method 'SolverGenNLMGEX::preCompute()'
      ...
      //
   gnssDataMap& SolverGenNLMGEX::Correct( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverGenNLMGEX::Compute()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssDataMap& SolverGenNLMGEX::MeasUpdate( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
      try
      {
                 ...
                 ++itVar )
            {
               ...
               if( (*itVar).getType() == TypeID::BL1)
               {
                  ...
                  //xhatminus(i) = std::floor( BLC/(-0.106953378) + 0.5 ) ;
						...
						{
							waveLen = -1*LC_WAVELENGTH_GPS;
						}

						if( sat.system == SatID::systemGalileo )
						{
							waveLen = -1*LC_WAVELENGTH_GAL_L1L5;
						}


                  xhatminus(i) = std::floor( BLC/(waveLen) + 0.5 ) ;
...
//			// Debug code vvv
//			cout << " before cov update in AmbOBSMeasUpdate: " << endl; 
//			de = 0;
//			for( VariableSet::iterator ite = currentUnknowns.begin();
//				  ite != currentUnknowns.end();
//				  ++ite )
...
//			// Debug code ^^^ 
   ...
   gnssDataMap& SolverGenNLMGEX::AmbiguityFixing( gnssDataMap& gData )
      throw(ProcessingException)
   {
...
//
   ...
   }  // End of method 'SolverGenNLMGEX::AmbiguityFixing()'
       ...
       */
   void SolverGenNLMGEX::AmbiguityUpdate( Vector<double>& state,
      ...
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverGenNLMGEX::AmbiguityUpdate()'
      ...
      // @param gData    Data object holding the data.
      //
   gnssDataMap& SolverGenNLMGEX::postCompute( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
...
//         }  // End of for( VariableSet::const_iterator itVar1 = currentUnknowns...'
   ...
   }  // End of method 'SolverGenNLMGEX::postMeasUpdate()'
       ...
       */
   double SolverGenNLMGEX::getSolution( const TypeID& type,
   ...
   }  // End of method 'SolverGenNLMGEX::getSolution()'
      ...
      throw(InvalidRequest)
   {
       ...
       * of this type, only the first one will be returned.
       */
   double SolverGenNLMGEX::getFixedSolution( const TypeID& type,
                                         const SourceID& source ) const
      throw(InvalidRequest)
   {
