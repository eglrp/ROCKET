...
class Variable;
   ...
   public:
      ...
      { return; };
          ...
          */
      virtual std::vector<TypeID>& getRelTypeIDVec()
      ...
      { m_relTypeIDVec.push_back(typeID); return (*this); }
   ...
   public:
          ...
          *
          */
      WhiteNoiseModel2( double sigma = 300000.0 )
      ...
      { variance = sigma*sigma; m_qMatrix(0,0) = variance; return (*this); }
   ...
   public:
      ...
      SatClkRandomWalkModel()
      {
         ...
         // add relative types for satellite 
         // clock stochastic model 
         m_relTypeIDVec.push_back( TypeID::dtSat );
         m_relTypeIDVec.push_back( TypeID::dtSatdot );
       
         // initialize qprime vector
         m_qprimeVec.push_back( 1.5e-6 );
         m_qprimeVec.push_back( 3e-10  );

         // initialize phi matrix for satellite clock drift model
         ...
         // initialize q matrix for satellite clock drift model
	...
	std::cout<<"p:"<<m_previousTime<<std::endl;
	std::cout<<"c:"<<m_currentTime<<std::endl;	
	...
	m_phiMatrix(0,1) = dt; 
     	return StochasticModel2::getPhi();
     }
   ...
   public:
      ...
      { variance = sigma*sigma; m_qMatrix(0,0)=sigma*sigma; return (*this); }
