...
namespace gpstk
{
   ...
   std::string BasicModelMGEX::getClassName() const
   { return "BasicModelMGEX"; }
       ...
       */
   BasicModelMGEX::BasicModelMGEX( const double& aRx,
                           const double& bRx,
                           const double& cRx,
   ...
   }  // End of 'BasicModelMGEX::BasicModelMGEX()'


      // Explicit constructor, taking as input a Position object
      // containing reference station coordinates.
   BasicModelMGEX::BasicModelMGEX(const Position& RxCoordinates)
   {
                           ...
                           const bool& applyTGD )
   {
       ...
       */
   satTypeValueMap& BasicModelMGEX::Process( const CommonTime& time,
      ...
      throw(ProcessingException)
   {
              ...
              ++stv )
         {
            ...
            //double observable( (*stv).second(defaultObservable) );
				...
				SatID sat( stv -> first );
					...
					// Find the default observable type for this sat syetem
				std::map< SatID::SatelliteSystem, TypeID >::iterator itSysType = 
											sysDefaultObservable.find( sat.system );
				if( itSysType != sysDefaultObservable.end() )
				{
					observable = (*stv).second( itSysType -> second  );
				}
				else
				{
					Exception e("Please specify the default type of system: " +
   ...
   }  // End of method 'BasicModelMGEX::Process()'
       ...
       *  -1 if problems arose
       */
   int BasicModelMGEX::setInitialRxPosition( const double& aRx,
                                         const double& bRx,
                                         const double& cRx,
                                         Position::CoordinateSystem s,
                                         EllipsoidModel *ell,
   ...
   }  // End of method 'BasicModelMGEX::setInitialRxPosition()'



      // Method to set the initial (a priori) position of receiver.
   int BasicModelMGEX::setInitialRxPosition(const Position& RxCoordinates)
   {
      ...
      // Method to set the initial (a priori) position of receiver.
   int BasicModelMGEX::setInitialRxPosition()
   {
      try
      {
   ...
   double BasicModelMGEX::getTGDCorrections( CommonTime Tr,
   ...
   }  // End of method 'BasicModelMGEX::getTGDCorrections()'
