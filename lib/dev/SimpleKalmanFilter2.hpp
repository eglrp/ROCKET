...
/**
 * @file SimpleKalmanFilter2.hpp
 * Class to compute the solution using a Kalman filter
 */

#ifndef SIMPLEKALMANFILTER2_HPP
#define SIMPLEKALMANFILTER2_HPP
...
//============================================================================
//  2016/10/28
//	 This class is an augmented version of SimpleKalmanFilter
//  Lei Zhao, SGG, WHU
//============================================================================
...
namespace gpstk
{
       ...
       *
       *    SimpleKalmanFilter2 kalman(xhat0, pmatrix);
       *
       *    while(cin >> x >> y)
       *    {
       *
   ...
   public:
      ...
      SimpleKalmanFilter2()
          ...
          */
      SimpleKalmanFilter2( const Vector<double>& initialState,
          ...
          *                              error variance.
          */
      SimpleKalmanFilter2( const double& initialValue,
      ...
      { 
         return Correct(measurements,
			 ...
			 *								the unknown vector
			 */ 
		virtual int Correct( const double& z,
									const double& weight,
   ...
   }; // End of class 'SimpleKalmanFilter2'
