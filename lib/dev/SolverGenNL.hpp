#pragma ident "$Id: SolverGenNL.hpp 2648 2011-06-09 08:01:41Z shjzhang $"

/**
 * @file SolverGenNL.hpp
...
namespace gpstk
{
       ...
       *
       * SolverGenNL is a program that inherited from the solverGeneral class,
       ...
       * @endcode
       *
       * \warning "SolverGenNL" is based on an Extended Kalman filter, and
       ...
       *
       */
   class SolverGenNL : public SolverBase, public ProcessingClass
   {
   public:
          ...
          *
          */
      SolverGenNL(const Equation& equation)
      ...
      { equSystem.addEquation(equation); };
          ...
          *                            be solved.
          **/
      SolverGenNL( const std::list<Equation>& equationList )
          : firstTime(true), fixAndHold(false)
      {
          ...
          *                            be solved.
          **/
      SolverGenNL( const EquationSystem2& equationSys )
         :firstTime(true), fixAndHold(false)
      {
      ...
      virtual void AmbiguityUpdate( Vector<double>& state,
          ...
          */
      virtual SolverGenNL& setIndepAmbiguityDatum( 
      ...
      { indepAmbDatum = ambDatum; return (*this); };
          ...
          * @param constrSystem  Object holding the constraint system
          */
      virtual SolverGenNL& setAmbType( const Variable& var)
      { ambType = var; return (*this); };

      virtual SolverGenNL& setFixAndHold( const bool& hold)
