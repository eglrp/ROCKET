...
/**
 * @file ComputeLinearMGEX.hpp
 * This class computes linear combinations of GDS data.
 */

#ifndef GPSTK_COMPUTELINEARMGEX_HPP
#define GPSTK_COMPUTELINEARMGEX_HPP
...
namespace gpstk
{
       ...
       * @endcode
       *
       * The "ComputeLinearMGEX" object will visit every satellite in the GNSS
       ...
       * taken as zero.
       *
       * \warning If the "ComputeLinearMGEX" object has more than one linear
       ...
       */
   class ComputeLinearMGEX : public ProcessingClass
   {
   public:
      ...
      { clearAll(); };
          ...
          */
      ComputeLinearMGEX( SatID::SatelliteSystem sys,
								 const gnssLinearCombination& linearComb )
      { sysLinearList[ sys ].push_back(linearComb); };
          ...
          */
      ComputeLinearMGEX(const LinearCombList& list)
         : linearList(list)
      { };
      ...
      virtual ComputeLinearMGEX& clearAll(void)
      { linearList.clear(); return (*this); };
          ...
          */
      virtual ComputeLinearMGEX& setLinearCombination(
      ...
      { clearAll(); linearList.push_back(linear); return (*this); };
          ...
          * @warning All previous linear combinations will be deleted.
          */
      virtual ComputeLinearMGEX& setLinearCombination(const LinearCombList& list)
      { clearAll(); linearList = list; return (*this); };
          ...
          */
      virtual ComputeLinearMGEX& addLinear(const gnssLinearCombination& linear)
      { 
		   ...
		   /** Add a linear combination to be computed.
          *
			 * @param sys		  sat system
          * @param linear    Linear combination definitions to be added.
          */
      virtual ComputeLinearMGEX& addLinear(
											SatID::SatelliteSystem sys,
											const gnssLinearCombination& linear)
      { 

			( sysLinearList[ sys ] ).push_back(linear);
			return (*this);
		};
   ...
   private:
      ...
      LinearCombList linearList;
			...
			/// System <---> LinearCombList
		std::map< SatID::SatelliteSystem, LinearCombList > sysLinearList;


   }; // End class ComputeLinearMGEX
