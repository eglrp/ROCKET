#pragma ident "$Id: SolverZapWL.cpp 2346 2012-05-23 15:55:58Z shjzhang $"

/**
 * @file SolverZapWL.cpp
...
namespace gpstk
{
   ...
   int SolverZapWL::classIndex = 9510000;


      // Returns an index identifying this object.
   int SolverZapWL::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverZapWL::getClassName() const
   { return "SolverZapWL"; }
       ...
       */
   gnssSatTypeValue& SolverZapWL::Process(gnssSatTypeValue& gData)
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverZapWL::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverZapWL::Process(gnssRinex& gData)
      throw(ProcessingException)
   {
       ...
       */
   gnssDataMap& SolverZapWL::Process(gnssDataMap& gdsMap)
      throw(ProcessingException)
   {
       ...
       * @param gData    Data object holding the data.
       */
   gnssDataMap& SolverZapWL::Predict( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
...
//          firstTime = false;
   ...
   }  // End of method 'SolverZapWL::preCompute()'
      ...
      //
   gnssDataMap& SolverZapWL::Correct( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverZapWL::Compute()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssDataMap& SolverZapWL::MeasUpdate( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
      try
      {
      ...
      start=clock();
              ...
              ++itamb )
         {
            ...
            dev = std::abs( amb - ambInt );
               ...
               // then the dev and ambVar should be very close to 
               // zero.
              ...
              ++itEq )
         {
                 ...
                 ++vcmIter )
            {
               ...
               VariableSet::const_iterator itVar1=floatUnkSet.find( (var) );
                  ...
                  // 'floatUnkSet'.
                  // Warning:
                  // All the fixed var's column equals with (numFloat+1),
   ...
   gnssDataMap& SolverZapWL::AmbiguityFixing( gnssDataMap& gData )
      throw(ProcessingException)
   {
            ...
            if(index != -1)
            {
               ...
               if( maxDec > cutDec )
               {
                  ...
                  newState(index) = bwFixed;
                     ...
                     // Insert the ambiguity into 'currAmbFixedMap'
                  currAmbFixedMap[(tempVar)] = bwFixed;
...
///               }
   ...
   }  // End of method 'SolverZapWL::AmbiguityFixing()'
       ...
       */
   void SolverZapWL::AmbiguityUpdate( Vector<double>& state,
      ...
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverZapWL::AmbiguityUpdate()'
      ...
      // @param gData    Data object holding the data.
      //
   gnssDataMap& SolverZapWL::postCompute( gnssDataMap& gdsMap )
      throw(ProcessingException)
   {
      ...
      start=clock();
              ...
              ++itEq )
         {
            ...
            if( residualType == TypeID::MWubbena )
            {
               cout << "postfitMWubbena " << postfitResiduals(i) << endl;
            }
   ...
   }  // End of method 'SolverZapWL::postMeasUpdate()'
       ...
       */
   double SolverZapWL::getSolution( const TypeID& type,
   ...
   }  // End of method 'SolverZapWL::getSolution()'
