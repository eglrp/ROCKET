#pragma ident "$ID: CC2NONCC2.hpp 2015-11-06 $"

#ifndef GPSTK_CC2NONCC2_HPP
#define GPSTK_CC2NONCC2_HPP
...
namespace gpstk
{
    ...
    *
    */
   class CC2NONCC2 : public ProcessingClass
   {
      public :

           // Default constructr
         CC2NONCC2()
            :copyC1ToP1(false), copyC2ToP2(false), dcbP1C1(NULL)                        
         {};
            ...
            */
         CC2NONCC2( DCBDataReader& dcbDataReader )
            ...
            */
         virtual CC2NONCC2& setRecType(const std::string& rectype);
            ...
            */
         virtual CC2NONCC2& loadRecTypeFile(const std::string& recfile);
            ...
            */
         virtual CC2NONCC2& setCopyC1ToP1(bool copy)
         { copyC1ToP1 = copy; return (*this); }
            ...
            * @param copy    boolean to indiate whether copy P1
            */
         virtual CC2NONCC2& setCopyC2ToP2(bool copy)
         { copyC2ToP2 = copy; return (*this); }
            ...
            * @param copy    boolean to indiate whether copy P1
            */
         virtual CC2NONCC2& setDCBDataReader(DCBDataReader& dcbReader)
   ...
   }; // End of class 'CC2NONCC2'

      // @}

}; // end of namespace gpstk

#endif   // GPSTK_CC2NONCC2_HPP
