#pragma ident "$Id: SolverGenUpd.hpp 2648 2011-06-09 08:01:41Z shjzhang $"

/**
 * @file SolverGenUpd.hpp
 * General Solver with ambiguity fixing.
 */

#ifndef GPSTK_SOLVERGENUpd_HPP
#define GPSTK_SOLVERGENUpd_HPP
...
namespace gpstk
{
       ...
       *
       * SolverGenUpd is a program that inherited from the solverGeneral class,
       ...
       * @endcode
       *
       * \warning "SolverGenUpd" is based on an Extended Kalman filter, and
       ...
       *
       */
   class SolverGenUpd : public SolverBase, public ProcessingClass
   {
   public:
          ...
          *
          */
      SolverGenUpd(const Equation& equation)
      ...
      { equSystem.addEquation(equation); };
          ...
          *                            be solved.
          **/
      SolverGenUpd( const std::list<Equation>& equationList )
          : firstTime(true), fixAndHold(false)
      {
          ...
          *                            be solved.
          **/
      SolverGenUpd( const EquationSystem2& equationSys )
         :firstTime(true), fixAndHold(false), 
			 ambiguityType(TypeID::Unknown), waveLength(0.0)
      {
      ...
      virtual void AmbiguityUpdate( Vector<double>& state,
          ...
          */
      virtual SolverGenUpd& setIndepAmbiguityDatum( 
      ...
      { indepAmbDatum = ambDatum; return (*this); };
          ...
          * @param constrSystem  Object holding the constraint system
          */
      virtual SolverGenUpd& setAmbType( const Variable& var)
      { ambType = var; return (*this); };


 
      virtual SolverGenUpd& setFixAndHold( const bool& hold)
      ...
      virtual std::string getClassName(void) const;
         ...
         /// Destructor.
      virtual ~SolverGenUpd() {};


   private:

			// Indicator of equation type
