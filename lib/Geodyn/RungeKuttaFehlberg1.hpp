...
/**
* @file RungeKuttaFehlberg1.hpp
* This class do integrations with Runge Kutta Fehlberg algorithm.
*/


#ifndef GPSTK_RUNGE_KUTTA_FEHLBERG1_HPP
#define GPSTK_RUNGE_KUTTA_FEHLBERG1_HPP
...
namespace gpstk
{
       ...
       */
   class RungeKuttaFehlberg1 : public Integrator
   {
   public:
   ...
   public:
      ...
      virtual Vector<double> integrateTo(const double&           t, 
         ...
         /// Set accuracy
      RungeKuttaFehlberg1& setAccuracy(const double& accuracy)
      { accuracyEps = accuracy; return (*this);}
         
         /// Set minimum stepsize
      RungeKuttaFehlberg1& setMinStepSize(const double& step)
      { minStepSize = step; return (*this ); }
      
         /// Set isAdaptive
      RungeKuttaFehlberg1& setAdaptive(const bool& adaptive = true)
   ...
   }; // End of class 'RungeKuttaFehlberg1'
...
#endif // GPSTK_RUNGE_KUTTA_FEHLBERG1_HPP
