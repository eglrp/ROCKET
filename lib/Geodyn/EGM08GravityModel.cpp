...
//         cout << "I" << line.substr( 5, 4) << "I" << endl;
//         cout << "I" << line.substr(10, 4) << "I" << endl;
//         cout << "I" << line.substr(17,22) << "I" << endl;
//         cout << "I" << line.substr(42,22) << "I" << endl;
//         cout << "I" << line.substr(68,16) << "I" << endl;
//         cout << "I" << line.substr(88,16) << "I" << endl;
...
//         cout << setw(4) << L << setw(4) << M
//              << setw(22) << doub2sci(C,22,3) << setw(22) << doub2sci(S,22,3)
//              << setw(22) << doub2sci(sigmaC,16,3) << setw(22) << doub2sci(sigmaS,16,3) << endl;

         int i = index(L,M) - 1;

         if(i <= gmData.normalizedCS.rows())
         {
            gmData.normalizedCS(i,0) = C;
            gmData.normalizedCS(i,1) = S;
         }
         else
         {
            break;
...
//              << setw(22) << doub2sci(gmData.normalizedCS(i,1),22,3) << endl;
      }
...
//        cout << "C10: " << doub2sci(gmData.normalizedCS(index(1,0)-1,0),22,3) << endl;
//        cout << "S10: " << doub2sci(gmData.normalizedCS(index(1,0)-1,1),22,3) << endl;
//        cout << "C20: " << doub2sci(gmData.normalizedCS(index(2,0)-1,0),22,3) << endl;
//        cout << "S20: " << doub2sci(gmData.normalizedCS(index(2,0)-1,1),22,3) << endl;

        gmData.normalizedCS(index(2,0)-1, 0) += leapYears*gmData.dotC20;
        gmData.normalizedCS(index(3,0)-1, 0) += leapYears*gmData.dotC30;
        gmData.normalizedCS(index(4,0)-1, 1) += leapYears*gmData.dotC40;

//        gmData.normalizedCS(index(11,0)-1, 0) = 0.0;
//        gmData.normalizedCS(index(12,0)-1, 0) = 0.0;
