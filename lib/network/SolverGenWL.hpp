#pragma ident "$Id: SolverGenWL.hpp 2648 2011-06-09 08:01:41Z shjzhang $"

/**
 * @file SolverGenWL.hpp
 * General Solver with ambiguity fixing.
 */

#ifndef GPSTK_SOLVERGENWL2_HPP
#define GPSTK_SOLVERGENWL2_HPP
...
namespace gpstk
{
       ...
       *
       * SolverGenWL is a program that inherited from the solverGeneral class,
       ...
       * @endcode
       *
       * \warning "SolverGenWL" is based on an Extended Kalman filter, and
       ...
       *
       */
   class SolverGenWL : public SolverBase, public ProcessingClass
   {
   public:
          ...
          *
          */
      SolverGenWL(const Equation& equation)
      ...
      { equSystem.addEquation(equation); };
          ...
          *                            be solved.
          **/
      SolverGenWL( const std::list<Equation>& equationList )
          : firstTime(true), fixAndHold(false)
      {
          ...
          *                            be solved.
          **/
      SolverGenWL( const EquationSystem2& equationSys )
         :firstTime(true), fixAndHold(false)
      {
      ...
      virtual void AmbiguityUpdate( Vector<double>& state,
          ...
          */
      virtual SolverGenWL& setIndepAmbiguityDatum( 
      ...
      { indepAmbDatum = ambDatum; return (*this); };
          ...
          * @param constrSystem  Object holding the constraint system
          */
      virtual SolverGenWL& setAmbType( const Variable& var)
      { ambType = var; return (*this); };


 
      virtual SolverGenWL& setFixAndHold( const bool& hold)
