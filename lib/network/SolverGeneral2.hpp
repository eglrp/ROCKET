#pragma ident "$Id: SolverGeneral2.hpp 2648 2011-06-09 08:01:41Z shjzhang $"
...
#ifndef GPSTK_SOLVERGEN2_HPP
#define GPSTK_SOLVERGEN2_HPP
...
namespace gpstk
{
       ...
       *
       * SolverGeneral2 is programmed using class "EquationSystem", that defines
       ...
       * SolverGeneral2 object to perform "Precise Point Positioning" (PPP):
       *
       * @code
       ...
       *
       *
       *      // SETUP "SolverGeneral2" OBJECT
       *
       *      // Create 'SolverGeneral2' object and add equation system
       *   SolverGeneral2 solver( eqSystem );
       *
       * @endcode
       *
       * The "SolverGeneral2" object is then ready to be fed with data
       ...
       * GDS is "gnssDataMap", which "SolverGeneral2" fully supports.
       *
       ...
       *
       * \warning "SolverGeneral2" is based on an Extended Kalman filter, and
       ...
       *
       */
   class SolverGeneral2 : public SolverBase, public ProcessingClass
   {
   public:
          ...
          */
      SolverGeneral2( const Equation& equation ) : firstTime(true)
      { equSystem.addEquation(equation); };
          ...
          *                      to be solved.
          */
      SolverGeneral2( const std::list<Equation>& equationList );
          ...
          *                            be solved.
          */
      SolverGeneral2( const EquationSystem2& equationSys ) : firstTime(true)
      { equSystem = equationSys; };


         /// Get a copy of the equation system being solved.
      virtual EquationSystem2 getEquationSystem() const
      { return equSystem; };
          ...
          *                            be solved.
          */
      virtual SolverGeneral2& setEquationSystem(
                                             const EquationSystem2& equationSys )
      { equSystem = equationSys; return (*this); };
          ...
          */
      virtual SolverGeneral2& addEquation( const Equation& equation )
      ...
      virtual SolverGeneral2& reset(void)
      ...
      virtual gnssDataMap& Process( gnssDataMap& gdsMap )
          ...
          * @param gdsMap    Data object holding the data.
          */
      virtual gnssDataMap& TimeUpdate( gnssDataMap& gdsMap )
         throw(ProcessingException);
   ...
   protected:
      ...
      Matrix<double> P;
          ...
          */
      virtual SolverGeneral2& setSolution( const Variable& variable,
                                          const double& val )
         throw(InvalidRequest);
          ...
          */
      virtual SolverGeneral2& setCovariance( const Variable& var1, 
                                            const Variable& var2,
                                            const double& cov)
         throw(InvalidRequest);
