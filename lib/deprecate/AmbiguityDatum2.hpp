...
/**
 * @file AmbiguityDatum2.hpp
 * Class to generate independent ambiguity map given 'gData'
 */

#ifndef GPSTK_AMBIGUITYDATUM2_HPP
#define GPSTK_AMBIGUITYDATUM2_HPP
...
namespace gpstk
{
      ...
      /// Thrown when attempting to use an invalid AmbiguityDatum2
      /// @ingroup exceptiongroup
   NEW_EXCEPTION_CLASS(InvalidAmbiguityDatum2, gpstk::Exception);
       ...
       * processed.
       *
       * In order to achieve this, the 'AmbiguityDatum2' class will start from a
       ...
       *
       *      // Create 'AmbiguityDatum2' object
       *   AmbiguityDatum2 eqSystem;
       *
   ...
   public:
      ...
      {};
          ...
          */
      virtual AmbiguityDatum2& setAmbType( const Variable& type);
          ...
          *
          */
      virtual AmbiguityDatum2& Prepare( gnssSatTypeValue& gData )
      { gnssRinex gds(gData); return ( Prepare(gds) ); };
          ...
          *
          */
      virtual AmbiguityDatum2& Prepare( gnssRinex& gData );
          ...
          *
          */
      virtual AmbiguityDatum2& Prepare( gnssDataMap& gdsMap );
         ...
         throw(InvalidAmbiguityDatum2)
      {
          ...
          */
      virtual VariableDataMap getAmbFixedMap( void )
         throw(InvalidAmbiguityDatum2);


         /// Destructor
      virtual ~AmbiguityDatum2() {};
   ...
   private:
      ...
      EdgeSet currentEdges;
         ...
         /// Whether or not this AmbiguityDatum2Net is ready to be used
      bool isPrepared;
   ...
   }; // End of class 'AmbiguityDatum2'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_AMBIGUITYDATUM2_HPP
