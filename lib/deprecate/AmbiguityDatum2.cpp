#pragma ident "$Id: AmbiguityDatum2.cpp 2939 2012-04-06 19:55:11Z shjzhang $"

/**
 * @file AmbiguityDatum2.cpp
...
namespace gpstk
{
       ...
       *
       */
   AmbiguityDatum2& AmbiguityDatum2::setAmbType( const Variable& inType)
   {

         // Add "ambType" to "ambTypeList"
      ambType = inType;

         // We must "Prepare()" this "AmbiguityDatum2"
      isPrepared = false;

      return (*this);

   }  // End of method 'AmbiguityDatum2::setAmbType()'
       ...
       */
   AmbiguityDatum2& AmbiguityDatum2::Prepare( gnssRinex& gData )
   {
   ...
   }  // End of method 'AmbiguityDatum2::Prepare()'
       ...
       *                   by SourceID.
       */
   AmbiguityDatum2& AmbiguityDatum2::Prepare( gnssDataMap& gdsMap )
   {
      ...
      // Prepare set of current unknowns and list of current constraints
   EdgeSet AmbiguityDatum2::prepareCurrentEdges( gnssDataMap& gdsMap )
   {
...
//             }
   ...
   }  // End of method 'AmbiguityDatum2::prepareCurrentEdges()'



      // Prepare set of current unknowns and list of current constraints
   EdgeSet AmbiguityDatum2::prepareCurrentIndepEdges()
   {
...
start=clock();
   ...
   }  // End of method 'AmbiguityDatum2::prepareCurrentIndepEdges()'


      // Get current sources (SourceID's) and satellites (SatID's)
   void AmbiguityDatum2::prepareCurrentSourceSat( gnssDataMap& gdsMap )
   {
   ...
   }  // End of method 'AmbiguityDatum2::prepareCurrentSourceSat()'



      /** Get the ambiguity datum which are fixed directly.
       */
   VariableDataMap AmbiguityDatum2::getAmbFixedMap( void )
      throw(InvalidAmbiguityDatum2)
   {

         // If the object as not ready, throw an exception
      if (!isPrepared)
      {
         GPSTK_THROW(InvalidAmbiguityDatum2("AmbiguityDatum2 is not prepared"));
      }

      return ambFixedMap;

   }  // End of method 'AmbiguityDatum2::getAmbFixedMap()'
