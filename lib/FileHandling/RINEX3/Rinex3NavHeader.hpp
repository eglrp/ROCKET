...
namespace gpstk
{
   ...
   public:
      ...
      enum validBits
      {
         ...
         validIonoCorrQZS =       0x020,    ///< Set if QZS Iono Correction data is valid.
         validIonoCorrBDS =       0x040,    ///< Set if BDS Iono Correction data is valid.
         validIonoCorrIRN =       0x080,    ///< Set if IRN Iono Correction data is valid.

         validTimeSysCorr =      0x0100,    ///< Set if Time System Correction is valid.
         validLeapSeconds =      0x0200,    ///< Set if the Leap Seconds value is valid.
