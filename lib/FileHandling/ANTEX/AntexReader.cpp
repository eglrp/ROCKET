   ...
   Antenna AntexReader::fillAntennaData( const std::string& firstLine )
   {
      ...
      while( label != endOfAntenna )
      {
         ...
         if( label == startOfFreq )
         {
            ...
            else if( freqString == "C01" ) freq = Antenna::C01;
            else if( freqString == "C02" ) freq = Antenna::C02;
            else if( freqString == "C06" ) freq = Antenna::C06;
            else if( freqString == "C07" ) freq = Antenna::C07;
