...
//		// To make sure the master station from configure file
//	
//	String masterStr = confReader.getValue( "masterStation"); 
//
//		// Master source
//	if( master.sourceName == masterStr )
//	{
//		cout << "master station name is: " << master.sourceName << endl;
//	}
//	else
//	{
//			// Find it in refStation
//		SourceIDSet::iterator itS = refStationSet.find( );
//		for( SourceIDSet)
//	}
...
//		// Debug code ^^^ 
      ...
      cout << printTime(workEpoch,"%4Y %02m %02d %02H %02M %02S") << " "
		...
		SourceIDSet initialValidSource( tempGds.getSourceIDSet() );
			...
			// Debug code vvv
//		cout << "valid stations: " << endl;
//
//		for( SourceIDSet::iterator ite = initialValidSource.begin();
//			  ite != initialValidSource.end();
//			  ++ite )
//		{
//			cout << *ite << " ";
//
//		}  // End of ' for( SourceIDSet::iterator ite = ... '
//
//		cout << endl;
//
//		cout << "new sats: " << endl;
//		gnssDataMap newGds( gds.extractSourceID( initialValidSource ) );
//		SatIDSet newSats( newGds.getSatIDSet() );
//		for( SatIDSet::iterator itSat = newSats.begin();
//			  itSat != newSats.end();
//			  ++itSat )
//		{
//			cout << *itSat << " ";
...
//		cout << "final source set: " << endl;
//		for( SourceIDSet::iterator ite = newSourceSet.begin();
//			  ite != newSourceSet.end();
//			  ++ite )
//		{
//			cout << *ite << " ";
//		}  
//		cout << "vvvvvv" << endl;
//
//		SourceIDSet sidSet( gds.getSourceIDSet() );
//		for( SourceIDSet::iterator ite = sidSet.begin();
//			  ite != sidSet.end();
//			  ++ite )
//		{
//			SourceID source( *ite );
//
//			gnssRinex tempgRin( gds.getGnssRinex( source ) );
//
//			double numSats( tempgRin.body.numSats() );
//
//			cout << source << " sats: " <<  numSats << endl;
//
//			SatIDSet satSet( tempgRin.body.getSatID() );
//			for( SatIDSet::iterator iter = satSet.begin(); 
//				  iter != satSet.end(); 
//				  ++iter )
//			{
//				cout << *iter << " ";
//			}  // End of ' for( SatIDSet::iterator iter = satSet.begin();  ... '
//
//			cout << endl;
//
//
//		}  // End of ' for( SourceIDSet::iterator ite ...'
		...
		// Debug code vvv
//		SatID sat9( 9, SatID::systemGPS );
//		SatID sat2( 2, SatID::systemGPS );
		// Debug code ^^^ 
			// I decide to solve the upd satellite by satellite
			// Lei Zhao, SGG, WHU
			// 2017.01.30

//			// Loop the satellite in gds
//		SatIDSet satSet( gds.getSatIDSet() );
//		for( SatIDSet::iterator itSat = satSet.begin();
//			  itSat != satSet.end();
//			  ++itSat )
//		{
...
//
//				// Copy of gds
//			gnssDataMap tempGds( gds );
//			
//				// Keep only this sat
//			tempGds.keepOnlySatID( sat );
//
//				// Compute upd
//			solverUpdWL.Process(tempGds);
//			solverUpdNL.Process(tempGds);
//			
//				// Store the upd solution for print 
