...
#include "CC2NONCC.hpp"
	...
	// Class to definite common equations
...
//                   const SolverGenNL& solverUpdNL);
      ...
      // Method to get clock bias products
   void getBiases( const CommonTime& workEpoch,
                   const SolverGenUpd& solverUpdWL,
                   const SolverGenUpd& solverUpdNL);
...
//   ////> Variables for the print out 
        ...
        ++itSet )
   {
      equ.equMWRef.addSource2Set( (*itSet) );
		...
		// Setup equation system
	EquationSystem2 system1, system2;
...
//	SolverGenWL solverUpdWL(system1);
//	SolverGenNL solverUpdNL(system2);
	SolverGenUpd solverUpdWL(system1), solverUpdNL(system2);

	IndepAmbiguityDatum ambConstrWL, ambConstrNL;
